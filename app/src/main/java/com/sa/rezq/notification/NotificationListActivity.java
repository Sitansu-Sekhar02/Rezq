package com.sa.rezq.notification;
...
import com.sa.rezq.services.model.NotificationListModel;
...
//        actionBar = getSupportActionBar();
    ...
    private void showEmptyPage() {
        if (progressLinearLayout != null) {
            progressLinearLayout.showEmpty(getResources().getDrawable(R.drawable.rezq_logo), getString(R.string.emptyList),
