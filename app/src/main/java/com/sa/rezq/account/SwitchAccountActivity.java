...
public class SwitchAccountActivity extends AppCompatActivity implements OpenInsertAccountInvoke, UploadListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_add_new_account = findViewById(R.id.btn_add_new_account);
