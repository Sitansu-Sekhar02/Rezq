...
public class AccountModel implements Serializable {
    ...
    List<AccountModel> orderModelList = new ArrayList<AccountModel>();
    ...
    public List<AccountModel> getOrderModelList() {
        return orderModelList;
    }

    public void setOrderModelList(List<AccountModel> orderModelList) {
