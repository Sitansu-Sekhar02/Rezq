...
public class TicketsListModel implements Serializable {

    private final String TAG = "TicketsListModel";

    private final String RESPONSE = "response";

    List<TicketModel> ticketList = new ArrayList<TicketModel>();

    public TicketsListModel(){}
    ...
    public String toString(){
        ...
        try{
            ...
            List<TicketModel> list = this.ticketList;
