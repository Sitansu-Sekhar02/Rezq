...
public class MembershipModel implements Serializable {
    ...
    private final String TAG = "MembershipModel";
    ...
    List<MembershipModel> orderModelList = new ArrayList<MembershipModel>();
    ...
    public List<MembershipModel> getOrderModelList() {
        return orderModelList;
    }

    public void setOrderModelList(List<MembershipModel> orderModelList) {
