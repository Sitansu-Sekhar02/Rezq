...
public class UpgradeOfferActivity extends AppCompatActivity {

    public static final String TAG = "UpgradeOfferActivity",
            BUNDLE_CATEGORY_LIST_DETAILS = "UpgradeOfferActivity";
    ...
    public static Intent newInstance(Activity activity, SeeAllCategoryModel listModel) {
        Intent intent = new Intent(activity, UpgradeOfferActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.offers_upgrade_activity);
