...
public class AllCategoryListActivity extends AppCompatActivity {
    ...
    public static final String TAG = "AllCategoryListActivity",
            BUNDLE_All_POPULAR_CATEGORY_LIST = "AllCategoryListActivity";
    ...
    public static Intent newInstance(Activity activity, SeeAllCategoryModel listModel) {
        Intent intent = new Intent(activity, AllCategoryListActivity.class);
        Bundle bundle = new Bundle();
        bundle.putSerializable(BUNDLE_All_POPULAR_CATEGORY_LIST, listModel);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recyclerview_category);
